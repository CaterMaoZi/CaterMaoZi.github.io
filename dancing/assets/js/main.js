  ...
  function init() {
    ...
    xhr.onload = function () {
      ...
      if (xhr.status >= 200 && xhr.status < 300) {
        ...
        if (catalog.site && catalog.site.notice) el('notice-text').innerHTML = catalog.site.notice;
        if (catalog.site && catalog.site.footer)   el('footer-text').innerHTML = catalog.site.footer;
        route();
      } else {
